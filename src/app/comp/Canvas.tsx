      ...
      <div className=" flex flex-col lg:flex-row items-center justify-center    w-full gap-4 mx-auto px-8">
        <div className="border border-black/[0.2] group/canvas-card flex items-center justify-center dark:border-white/[0.2]  max-w-sm w-full mx-auto p-4 relative h-[30rem] relative">
          ...
          <div className="relative z-20">
            <div className="text-center flex-row text-white group-hover/canvas-card:-translate-y-4 group-hover/canvas-card:opacity-0 transition duration-200 w-full  mx-auto items-center justify-center text-9xl mt-[20%] font-bold ">
            <div className="">
            ?
            </div>
            
            <div className="text-sm mt-10">
            Can You Guess this Pokemon
            </div>
            </div>
            <br/>
